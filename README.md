...
- **Dashboard** - 用户面板，余额/用量/账单/图表
- **Admin 面板** - 系统监控，请求日志/状态码/国家分布
...
| 注册 | `https://silkgateway.ai/register/` | 用户注册 |
| Dashboard | `https://silkgateway.ai/dashboard/` | 用户面板 |
| 文档 | `https://silkgateway.ai/docs/` | API 文档 |
| 监控 | `https://silkgateway.ai/admin/` | 系统监控 |
